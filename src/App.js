...
class App extends Component {
	...
	performSubmisionRequest = (data, id) => {
		if (id) {
	...
	submitNote = (data, id) => {
		this.performSubmisionRequest(data, id)
	...
	render() {
		const { showNote, notes, note, newTag, error } = this.state; /*object destructuring, equivalent to this.state.showNote <p>{this.state.showNote</p> */
		return (
		<div className="App">
